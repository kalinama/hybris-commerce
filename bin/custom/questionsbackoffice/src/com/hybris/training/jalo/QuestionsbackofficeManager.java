...
import com.hybris.training.constants.QuestionsbackofficeConstants;
...
public class QuestionsbackofficeManager extends GeneratedQuestionsbackofficeManager
{
	 ...
	 */
	public static QuestionsbackofficeManager getInstance()
	{
		return (QuestionsbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(QuestionsbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public QuestionsbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of QuestionsbackofficeManager called.");
		}
	}
