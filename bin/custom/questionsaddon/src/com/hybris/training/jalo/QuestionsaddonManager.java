...
/**
 * This is the extension manager of the Questionsaddon extension.
 */
public class QuestionsaddonManager extends GeneratedQuestionsaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(QuestionsaddonManager.class.getName());
	 ...
	 */
	public static QuestionsaddonManager getInstance()
	{
		return (QuestionsaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				QuestionsaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public QuestionsaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of QuestionsaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of QuestionsaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of QuestionsaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
